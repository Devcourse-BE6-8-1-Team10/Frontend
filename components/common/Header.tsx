...
import {Coffee, LogIn, LogOut, Shield, ShoppingCart, User} from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center">
                    ...
                    <div className="ml-auto">
                        {!isLogin ? (
                            <Button icon={LogIn} text="로그인" onClick={() => setLogin(true)}/>
                        ) : (
                            <div className="flex items-center space-x-4">
                                {isAdmin && (
                                ...
                                <Button icon={LogOut} text="로그아웃" onClick={() => setLogin(false)}/>
                            </div>
                        )}
                    </div>
                </div>
